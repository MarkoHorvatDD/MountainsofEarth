 ...
 */
public class CameroonFragment extends NotificationsFragment {


    public CameroonFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fr.replace(R.id.fragment_container,new MapsCameroon()).addToBackStack(null);
